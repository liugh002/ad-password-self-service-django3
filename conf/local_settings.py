...
# 企业微信的企业ID
WEWORK_CORP_ID = r'ww99d2ff9b20a00190'
# 应用的AgentId
WEWORK_AGENT_ID = r'1000002'
# 应用的Secret
WEWORK_AGNET_SECRET = r'7urOSFLOlwIrcgh8q-qFHQcYKjr0segFFvadwcBOyVQ'
...
# 如果是自定义安装，请修改成自己的域名
HOME_URL = '44l8779a01.qicp.vip:8000'